const ApiKey = "3a16c45517b543a0bbf73d7510fa5da2";
...
function showTeamInfo(id) {
    ...
    fetch(url, fetchHeader)
        ...
        .then(resJson => {
            ...
            title.innerHTML = "Daftar Pemain " + shortName;
            contents.innerHTML = `
                <img src="${crestUrl}" alt="${name}" width="80px">
                <div class="divider"></div>
                <div class="section">
                <th>CLUB NAME    : ${name}</th> 
                </div>
                <div class="divider"></div>
                <div class="section">
                <th>STADION NAME : ${venue}</th>
                </div>
                <div class="divider"></div>
                <div class="section">
                ...
                <div class="divider"></div>
                <div class="section">
                <th>KOMPETISI    : ${activeCompetitions}</th>
                <br>
